DMC supports online migration from YashanDB to YashanDB, including full data synchronization and incremental data synchronization.

It is recommended to perform full data synchronization when there is less business activity on the source side to reduce the impact on online operations and to achieve a better user experience.

Please read the migration guidance in the order listed in this manual before starting the migration task to avoid unpredictable errors.
