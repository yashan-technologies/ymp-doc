Before starting a migration task, a series of task parameter configurations must be completed. DMC configures these parameters by directly editing the task configuration file. The default task configuration file is the task_config.yml file located in the conf directory.
...
In this, the database connection passwords for the source and target must be securely filled in after encryption using the DMC client, as follows:
