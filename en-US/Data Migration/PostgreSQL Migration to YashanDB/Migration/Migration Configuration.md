...
* Supports renaming Schema (that is, configuring a target Schema with a name different from the source Schema). The input name cannot exceed 64 characters and can only contain English letters, numbers, and the special character _.
