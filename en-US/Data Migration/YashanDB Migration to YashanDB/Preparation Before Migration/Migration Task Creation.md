...
**Online assessment is only available when the source is YashanDB.**
...
| Source Database       | Select YashanDB                                          |
...
> **Note**:
>
> If the migration task plan uses a non-persistent migration method, the task name length must be within 40 characters, consisting of letters, numbers, underscores, and English characters.
