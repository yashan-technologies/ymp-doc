This document is based on the existing syntax of Oracle 21c and has undergone a structured transformation according to SQL conversion rules.

## Overview

During the task evaluation phase of YMP, a compatibility assessment of objects in the source database (tables, views, constraints, indexes, etc.) will be conducted to ensure that the source database objects can be successfully migrated to the target database. In the assessment phase, the DDL of the source database objects will be attempted to be obtained and executed in the target database. If the execution is successful, it indicates that the object is natively compatible and does not require special handling. Otherwise, SQL conversion tools will be used to convert this DDL based on the syntax conversion rules from the source to the target database to adapt to the syntax features of the target database. If the conversion is successful, an attempt will be made to execute the converted SQL in the target database. Successful execution indicates that this object is automatically compatible and can be migrated.

## CREATE TABLE
|Serial No. |ORACLE Syntax/Keywords |YashanDB22.2 Conversion Rule |YashanDB23.1 Conversion Rule |
|---------|------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|----------------------------------|------------------|
| [1](#1) | constraint_state ::= <br>[ NOT DEFERRABLE] <br>[INITIALLY IMMEDIATE]<br>[ RELY &#124; NORELY ]<br>[ using_index_clause ]<br>[ ENABLE &#124; DISABLE ]                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                          | Retain all                             | Same as 22.2            |
| [2](#2) | using_index_clause::= <br>USING INDEX<br>{(create_index_clause) &#124; index_attr_clause}<br>Note: refer to create index for create_index_clause and index_attr_clause                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                         | Retain supported create index and index_attr syntax | Same as 22.2            |
| [3](#3) | segment_attributes_clause=:: <br>logging_clause=::<br>NOLOGGING&#124;FILESYSTEM_LIKE_LOGGING;                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                              | Retain logging_clause                 | Same as 22.2            |
| [4](#4) | storage_clause=::<br>STORAGE<br>({<br>NEXT size_clause <br>&#124; MINEXTENTS integer<br> MAXEXTENTS { integer &#124;UNLIMITED } <br>&#124; PCTINCREASE integer <br>&#124; FREELISTS integer<br>&#124; FREELIST GROUPS integer <br>&#124; BUFFER_POOL { KEEP &#124; RECYCLE &#124; DEFAULT }<br>&#124; FLASH_CACHE { KEEP &#124; NONE &#124; DEFAULT }<br>&#124; ( CELL_FLASH_CACHE ( KEEP &#124; NONE &#124; DEFAULT ) )<br>} ...<br>)                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                         | Retain all                             | Same as 22.2            |
| [5](#5) | table_properties=::<br>[ read_only_clause ]<br>[ CACHE&#124; NOCACHE ]<br>[ parallel_clause ]                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                              | Retain all                             | Same as 22.2            |
| [6](#6) | LOB_storage_clause=:: <br>LOB <br>{ (LOB_item [, LOB_item ]...) <br>STORE AS { [SECUREFILE &#124; BASICFILE] (LOB_storage_parameters)<br>} <br>&#124; (LOB_item) <br>STORE AS { [SECUREFILE &#124; BASICFILE] (LOB_storage_parameters)<br>} <br>} <br>Note: new supported items are [SECUREFILE &#124; BASICFILE] parameters                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                          | Retain all                             | Same as 22.2            |
| [7](#7) | table_partitioning_clauses=:: <br>composite_range_partitions <br>&#124; composite_list_partitions <br>&#124; composite_hash_partitions <br>&#124; consistent_hash_with_subpartitions <br><br>composite_range_partitions=::<br>PARTITION BY RANGE ( column [, column]... )<br>   { subpartition_by_range<br>   &#124; subpartition_by_list<br>   &#124; subpartition_by_hash<br>   }<br> ( range_partition_desc [, range_partition_desc ]... )<br>Note: does not support [ INTERVAL ( expr ) [ STORE IN ( tablespace [, tablespace]... ) ]] <br><br>composite_list_partitions=::<br>PARTITION BY LIST ( column [, column]... )<br>   { subpartition_by_range<br>   &#124; subpartition_by_list<br>   &#124; subpartition_by_hash<br>   }<br> ( list_partition_desc [, list_partition_desc]... )<br>Removed [ AUTOMATIC [ STORE IN ( tablespace [, tablespace ]... ) ] ] <br><br>composite_hash_partitions=:: <br>PARTITION BY HASH (column [, column ] ...)<br>   { subpartition_by_range<br>   &#124; subpartition_by_list<br>   &#124; subpartition_by_hash<br>   }<br>   {  hash_partitions_by_quantity}<br>Note: does not support individual_hash_partitions &#124;<br><br>consistent_hash_with_subpartitions=::<br>PARTITION BY CONSISTENT HASH (column [, column ]...)<br>   { subpartition_by_range<br>   &#124; subpartition_by_list<br>   &#124; subpartition_by_hash<br>   }<br>   [ PARTITIONS AUTO ] | Not supported in 22.2                         | Retain all except unsupported parts      |
| 8 | identity_clause=:: GENERATED [ ALWAYS &#124; BY DEFAULT [ ON NULL ] ]AS IDENTITY [ ( identity_options ) ] <br> identity_options =:: { START WITH ( integer &#124; LIMIT VALUE ) &#124; INCREMENT BY integer &#124; ( MAXVALUE integer &#124; NOMAXVALUE ) &#124; ( MINVALUE integer &#124; NOMINVALUE ) &#124; ( CYCLE &#124; NOCYCLE ) &#124; ( CACHE integer &#124; NOCACHE ) &#124; ( ORDER &#124; NOORDER ) }...                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                       | Converted to auto-increment sequence                            | Retain all             |

## ALTER TABLE
|Serial No. |Oracle Syntax/Keywords |YashanDB22.2 Conversion Rule |YashanDB23.1 Conversion Rule |
|----------|--------------------------------------------------------------------------------------------------------------------------|------------------|------------------|
| [9](#8)  | [alter_table_properties] =:: <br>readonly_clause::=[READ ONLY &#124; READ WRITE] <br>&#124;logging_clause=::[LOGGING&#124;NOLOGGING] | Retain all             | Retain all             |
| [10](#9) | [truncate_partition_subpart]=:: <br>TURNCATE {PARTITION} {partition_name} <br>[ DROP &#124;REUSE STORAGE] [ CASCADE ]        | Retain all             | Retain all             |

## CREATE INDEX
|Serial No. |Oracle Syntax/Keywords |YashanDB22.2 Conversion Rule |YashanDB23.1 Conversion Rule |
|-----------|--------------------------------------------------------------------------------------------------------------------------------------------------------|------------------|------------------|
| [11](#10) | CREATE [UNIQUE] INDEX [schema.]index_name ON table_index_index_clause {USABLE &#124;&#124; UNUSABLE} <br>Note: new support {USABLE &#124;&#124; UNUSABLE}                          | Retain all             | Same as 22.2            |
| [12](#11) | [table_index_index_clause]=:: <br>[schema.]table (column [ASC&#124;&#124;DESC],..)  <br>[index_properties] <br>Note: New supported items are column [ASC&#124;&#124;DESC] options                       | Retain all             | Same as 22.2            |
| [13](#12) | [index_attributes]=:: <br>[COMPRESS num &#124;NOCOMPRESS] <br>&#124;[VISIBLE&#124;INVISIBLE]<br>&#124; [PARALLEL num &#124;NOPARALLEL] <br>&#124;[logging&#124;nologging]&#124;REVERSE | Retain all             | Same as 22.2            |

## CREATE VIEW
|Serial No. |Oracle Syntax/Keywords |YashanDB22.2 Conversion Rule |YashanDB23.1 Conversion Rule |
|-----------|------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|------------------|------------------|
| [14](#13) | CREATE [OR REPLACE] [[NO] FORCE] [ EDITIONABLE  &#124; NONEDITIONABLE ]  VIEW [schema "."] view_name AS subquery [with read only]<br>Note: New supported items are [[NO] FORCE] [ EDITIONABLE  &#124; NONEDITIONABLE ] [with read only] | Retain all             | Retain all             |

## CREATE MATERIALIZED VIEW

|Serial No. |Oracle Syntax/Keywords |YashanDB22.2 Conversion Rule |YashanDB23.1 Conversion Rule |
|-----------|-----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|------------------|------------------|
| [15](#14) | CREATE MATERIALIZED VIEW [ schema. ] materialized_view<br/>[(,{column_alias ...})]<br/>{physical_properties materialized_view_props} <br>[ create_mv_refresh ] <br>[ query_rewrite_clause ] <br>AS subquery ; <br><br>physical_properties=::  <br>segment_attributes_clause::= <br>TABLESPACE tablespace <br><br>materialized_view_props::=  <br>build_clause::= <br>BUILD { IMMEDIATE &#124; DEFERRED } <br><br>create_mv_refresh::= <br>{ REFRESH { { COMPLETE &#124; FORCE } &#124; { ON DEMAND &#124; ON COMMIT }  <br>&#124; { START WITH date &#124; NEXT date }... &#124; NEVER REFRESH }  <br><br>query_rewrite_clause::= <br>{ ENABLE &#124; DISABLE } QUERY REWRITE | YashanDB22.2 does not have this syntax | Retain all             |
...
|Serial No. |Oracle Syntax/Keywords |YashanDB22.2 Conversion Rule |YashanDB23.1 Conversion Rule |
|-----------|----------------------------------|------------------------------------------------------------------------|------------------|
| [17](#16) | plsql_type_source                | Remove OID/Sharing_clause /default_collation_clause/accessible_by_clause during conversion | Same as left               |
| [18](#16) | object_type_def/varray_type_spec | Remove (NOT INSTANTIABLE)&#124;(NOT PERSISTABLE)                             | Same as left               |
| [19](#18) | element_spec                     | Remove inheritance_clauses/restrict_references_pragma                   | Same as left               |
| [20](#19) | constructor_spec                 | Remove FINAL/ INSTANTIABLE /call_spec                                    | Same as left               |

## CREATE TRIGGER
|Serial No. |Oracle Syntax/Keywords |YashanDB22.2 Conversion Rule |YashanDB23.1 Conversion Rule |
|-----------|-------------------------|-----------------------------------------------|------------------|
| [21](#20) | plsql_trigger_source    | Remove Sharing_clause /default_collation_clause during conversion | Same as left               |
| 22        | referencing_clause      | Conversion fails if it contains parent as                          | Same as left               |
| [23](#20) | trigger_edition_clause  | Remove                                         | Same as left               |
| 24      | trigger_ordering_clause | Conversion fails if it contains precedes                           | Same as left               |
| 25      | instead_of_dml_trigger  | Normal conversion not supported                                       | Same as left               |
| 26      | system_trigger          | Normal conversion not supported                                       | Same as left               |
| 27      | compound_dml_trigger    | Normal conversion not supported                                       | Same as left               |

## CREATE FUNCTION
|Serial No. |Oracle Syntax/Keywords |YashanDB22.2 Conversion Rule |YashanDB23.1 Conversion Rule |
|-----------|----------------------------|------------------------------------------------------------------------------------------------------------------------------------------------------------------------|------------------|
| [28](#21) | or replace                 | Normal conversion                                                                                                                                                                   | Same as left               |
| [29](#21) | EDITIONABLE/NONEDITIONABLE | Normal conversion                                                                                                                                                                   | Same as left               |
| [30](#21) | plsql_function_source      | Remove sharing_clause/accessible_by_clause/default_collation_clause/deterministic_clause/parallel_enable_clause/ result_cache_clause/aggregate_clause/pipelined_clause/sql_macro_clause during conversion | Same as left               |
| 31        | call_spec                  | Normal conversion not supported                                                                                                                                                                | Same as left               |

## CREATE PROCEDURE
|Serial No. |Oracle Syntax/Keywords |YashanDB22.2 Conversion Rule |YashanDB23.1 Conversion Rule |
|-----------|----------------------------|------------------------------------------------------------------------------------------------------------------------------------------------------------------------|------------------|
| 32        | or replace                 | Normal conversion                                                                                                                                                                   | Same as left               |
| 33        | EDITIONABLE/NONEDITIONABLE | Normal conversion                                                                                                                                                                   | Same as left               |
| [34](#22) | plsql_procedure_source     | Remove sharing_clause/accessible_by_clause/default_collation_clause during conversion | Same as left               |
| 35        | call_spec                  | Normal conversion not supported                                                                                                                                                                | Same as left               |

## CREATE PACKAGE
|Serial No. |Oracle Syntax/Keywords |YashanDB22.2 Conversion Rule |YashanDB23.1 Conversion Rule |
|-----------|----------------------------|------------------------------------------------------------------------------------------------------------------------------------------------------------------------|------------------|
| 36        | or replace                 | Normal conversion                                                                                                                                                                   | Same as left               |
| 37        | EDITIONABLE/NONEDITIONABLE | Normal conversion                                                                                                                                                                   | Same as left               |
| [38](#23) | plsql_package_source       | Remove sharing_clause/accessible_by_clause/default_collation_clause during conversion | Same as left               |
| [39](#21) | plsql_package_body_source  | Remove sharing_clause | Same as left               |
| 40      | call_spec                  | Normal conversion not supported                                                                                                                                                                | Same as left               |
...
-- YashanDB23.1 Expected Result
-- Same as YashanDB22.2
 ```
...
-- YashanDB22.2 Expected Result
-- YashanDB22.2 does NOT have this syntax
